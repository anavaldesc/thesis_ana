...
\end{equation}
%
where the weights are a combination of uncertainties in the fits and the trajectory of the Dirac point during the loading procedure for the case of the topological branch. Figure \note{TODO:make mask figure} shows an example of two weight arrays corresponding to the two different trajectories of the Dirac point. 
