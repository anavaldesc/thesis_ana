...
To avoid confusion between dressed state $xyz$ labels and Cartesian coordinates indicating the Raman geometry, in this Chapter I will use the numbers $1,2,3$ to label the spatial coordinates and the letters $x,y,z$ to label clock state parameters. 
...
We can consider the degenerate states as pseudospins which are described to zeroth order by the Rashba plus free particle Hamiltonian
%
\begin{equation}
