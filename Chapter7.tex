...
The Chern number is used to describe the topology of Bloch bands, where the relevant parameter space is defined by the crystal momentum or quasimomentum in the Brillouin zone (BZ). 


Therefore we can see that the Chern number can be interpreted as the flux across the BZ from Dirac monopoles in momentum space. There have been experiments~\cite{roushan_observation_2014,sugawa_second_2018} that realize and measure topologically non-trivial systems in more abstract parameter spaces.  
