...
The existence of this phase was a bit surprising when 
...
\end{align}
% \begin{equation}
% 	\gamma_n(\mathcal{C})=\frac{q}{\hbar}\oint_{\mathcal{C}}\mathbf{A}(\mathbf{r})\cdot d\mathbf{r}=\frac{q\Phi_B}{\hbar},
% 	\label{eq:aharonov_bohm_phase}
% \end{equation}
%
