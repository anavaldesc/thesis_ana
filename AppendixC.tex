...
\end{figure*}
 ...
 %I will show later that all states can be coupled using a combination of the $\fx$, $\fy$, and $\fz$ operators in the lab frame, i.e. using different combinations of Raman laser beams with appropriately chosen polarizations. 
...
% %
% I will derive the the Rashba Hamiltonian from first principles, without sweeping undesired off-resonant couplings under the rug. 
