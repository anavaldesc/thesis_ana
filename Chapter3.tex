...
\end{equation}
%
Figure \note{TODO: make Ramsey fringe figure} shows blah.     
...
\end{equation}
%
Figure \note{TODO: make figure of abs imaging} show the different images used to compute the OD. In practice we take a third image of the background intensity $I_{\rm {bg}}$ and subtract it from the other two images.  
